...
public class CookingList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cooking_list);
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (expert != null && "Cooking".equals(expert.getService())) {
                        list.add(expert);
                    }
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CookingList.this, "Error fetching data", Toast.LENGTH_SHORT).show();
            }
        });
    }
